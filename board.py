...
class board:
    def board_init():
        ...
        rail_1 = event('Rail 1', 5)                                                 #Ownable event
        ...
        board = [go, brown_1, community_chest, brown_2, income_tax, rail_1, light_b_1, chance, light_b_2, light_b_3, jail, pink_1, telecom_1, pink_2, pink_3, rail_2, orange_1, community_chest, orange_2, orange_3, free_parking, red_1, chance, red_2, red_3, rail_3, yellow_1, yellow_2, telecom_2, yellow_3, go_2_jail, green_1, green_2, community_chest, green_3, rail_4, chance, dark_b_1, liberty_tax, dark_b_2]
