...
class board:
    def board_init():
        ...
        rail_1 = ownable_event('Rail 1', 5, 200, 0, 0)                                                 #Ownable event
        ...
        util_1 = ownable_event("Util 1", 12, 150, 0, 0)                                        #Ownable event
        pink_2 = property("Pink 2", 140, (10,50,150,450,625,750), 0, 0)
        pink_3 = property("Pink 3", 160, (12,60,180,500,700,900), 0, 0)
        rail_2 = ownable_event('Rail 2', 15, 200, 0, 0)                                                #Ownable event
        ...
        rail_4 = ownable_event('Rail 4', 35, 200, 0, 0)
        #Chance
